 ...
 * Data Declaration
 */
static const rtk_switch_model_t rtl8382m_8218b_intphy_8218b_8214qf_demo = {
    .name = "RTL8382M_8218B_INTPHY_8218B_8214QF_DEMO",
    ...
    .phy.list = {
        ...
        [3] =   { .chip = RTK_CHIP_RTL8214QF, .mac_id = 24,  .phy_max = 4 },
    }   /* .phy.list */
};
