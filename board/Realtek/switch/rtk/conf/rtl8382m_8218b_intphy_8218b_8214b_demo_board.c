 ...
 * Data Declaration
 */
static const rtk_switch_model_t rtl8382m_8218b_intphy_8218b_8214b_demo = {
    .name = "RTL8382M_8218B_INTPHY_8218B_8214B_DEMO",
    ...
    .led.sel_p0_p23_led_mod = 0,
    .led.sel_p24_p27_led_mod = 0,
