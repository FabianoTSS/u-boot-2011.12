 ...
 * Data Declaration
 */
static const rtk_switch_model_t rtl8391m_14c_demo = {
    .name = "RTL8391M_14C_DEMO",
    ...
    .serdes.list = {
        ...
        { .sds_id = 4,  .phy_idx = 2},
        { .sds_id = 5,  .phy_idx = 2},
        { .sds_id = 6,  .phy_idx = 3, .rx_polarity = SERDES_POLARITY_CHANGE, .tx_polarity = SERDES_POLARITY_NORMAL},
    },  /* serdes.list */
    ...
    .phy.list = {
        ...
        [3] = { .chip = RTK_CHIP_RTL8214C,  .mac_id = 24, .phy_max = 4},
    },   /* .phy.list */
