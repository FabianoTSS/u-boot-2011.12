 ...
 * Data Declaration
 */
static const rtk_switch_model_t rtl8391m_14qf_14qf_14fc_demo = {
    .name = "RTL8391M_14QF_14QF_14FC_DEMO",
    .chip = RTK_CHIP_RTL8391M,
    ...
    .serdes.list = {
        ...
        { .sds_id = 1,  .phy_idx = 0, .mii = RTK_MII_NONE, .rx_polarity = SERDES_POLARITY_NORMAL, .tx_polarity = SERDES_POLARITY_NORMAL},
        { .sds_id = 2,  .phy_idx = 1, .mii = RTK_MII_QSGMII, .rx_polarity = SERDES_POLARITY_NORMAL, .tx_polarity = SERDES_POLARITY_NORMAL},
        { .sds_id = 3,  .phy_idx = 1, .mii = RTK_MII_NONE, .rx_polarity = SERDES_POLARITY_NORMAL, .tx_polarity = SERDES_POLARITY_NORMAL},
        { .sds_id = 4,  .phy_idx = 2, .mii = RTK_MII_QSGMII, .rx_polarity = SERDES_POLARITY_NORMAL, .tx_polarity = SERDES_POLARITY_NORMAL},
        { .sds_id = 5,  .phy_idx = 2, .mii = RTK_MII_NONE, .rx_polarity = SERDES_POLARITY_NORMAL, .tx_polarity = SERDES_POLARITY_NORMAL},
    },  /* serdes.list */
    ...
    .phy.list = {
        ...
        [2] = { .chip = RTK_CHIP_RTL8214FC,  .mac_id = 16, .phy_max = 4},
    },   /* .phy.list */
