 ...
 * Data Declaration
 */
static const rtk_switch_model_t rtl8393m_8218d = {
    .name = "RTL8393M_8218D",
    ...
    .phy.list = {
        ...
        [1] = { .chip = RTK_CHIP_RTL8218D,  .mac_id = 8 , .phy_max = 8 },
        [2] = { .chip = RTK_CHIP_RTL8218D,  .mac_id = 16, .phy_max = 8 },
        [3] = { .chip = RTK_CHIP_RTL8218D,  .mac_id = 24, .phy_max = 8 },
        [4] = { .chip = RTK_CHIP_RTL8218D,  .mac_id = 32, .phy_max = 8 },
        [5] = { .chip = RTK_CHIP_RTL8218D,  .mac_id = 40, .phy_max = 8 },
    },   /* .phy.list */
