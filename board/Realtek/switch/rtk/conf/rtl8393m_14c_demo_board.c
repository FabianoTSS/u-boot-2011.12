 ...
 * Data Declaration
 */
static const rtk_switch_model_t rtl8393m_14c_demo = {
    .name = "RTL8393M_14C_DEMO",
    ...
    .serdes.list = {
        ...
        { .sds_id = 12, .phy_idx = 6, .rx_polarity = SERDES_POLARITY_CHANGE, .tx_polarity = SERDES_POLARITY_NORMAL},
    },  /* serdes.list */
    ...
    .phy.list = {
        ...
        [6] = { .chip = RTK_CHIP_RTL8214C, .mac_id = 48, .phy_max = 4 },
    },   /* .phy.list */
