 ...
 * All rights reserved.
 *
 * Purpose : Related implementation of the RTL8382M_8218D_2FIB demo board for U-Boot.
 *
 * Feature : RTL8382M_8282B_2FIB demo board database
 *
 */
 ...
 * Data Declaration
 */
static const rtk_switch_model_t rtl8382m_8218d_intphy_8218d_2fib_1g_demo = {
    .name = "RTL8382M_8218D_INTPHY_8218D_2FIB_1G_DEMO",
    ...
    .phy.count = 4,
    .phy.list = {
        [0] =   { .chip = RTK_CHIP_RTL8218D, .mac_id = 0,  .phy_max = 8 },
        [1] =   { .chip = RTK_CHIP_RTL8218B, .mac_id = 8,  .phy_max = 8 },
        [2] =   { .chip = RTK_CHIP_RTL8218D, .mac_id = 16,  .phy_max = 8 },
