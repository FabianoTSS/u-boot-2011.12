 ...
 * Data Declaration
 */
static const rtk_switch_model_t rtl8381m_intphy_8214fc_2fib_1g_demo = {
    .name = "RTL8381M_INTPHY_8214FC_2FIB_1G_DEMO",
    .chip = RTK_CHIP_RTL8381M,
    ...
    .phy.list = {
        ...
        [1] =   { .chip = RTK_CHIP_RTL8214FC, .mac_id = 16,  .phy_max = 4 },
        [2] =   { .chip = RTK_CHIP_NONE, .mac_id = 24,  .phy_max = 2 },
    }   /* .phy.list */
};
