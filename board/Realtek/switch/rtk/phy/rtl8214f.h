...
extern int rtl8214fb_linkDownPowerSavingEnable_set(int port, int enable);
extern int rtl8214fb_greenEnable_set(int port, int enable);
extern int rtl8214fb_crossOverMode_set(int port, int mode);
