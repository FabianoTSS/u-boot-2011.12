...
{
		extGpio_pin_dir_set(RTL8231_ADDR,pinNum,rtl8231_PIN_DIR_IN);
		extGpio_pin_data_get(RTL8231_ADDR,pinNum,pinStatus);
		return;
}

void rtl8231_pin_status_set(unsigned int pinNum, unsigned int pinStatus)
{
		extGpio_pin_dir_set(RTL8231_ADDR,pinNum,rtl8231_PIN_DIR_OUT);
		extGpio_pin_data_set(RTL8231_ADDR,pinNum,pinStatus);
}
