...
/* 16MB flash layout */
    ...
    /* 32MB flash layout */
        #define LOADER_START        (0x00000000U)                                   //0x00000000
        #define LOADER_SIZE         (UNIT_SIZE*14)                                   //0x00080000
        #define LOADER_BDINFO_START (LOADER_START+LOADER_SIZE)
        #define LOADER_BDINFO_SIZE  (UNIT_SIZE*2)
        #define RTK_KERNEL_START    (LOADER_BDINFO_START+LOADER_BDINFO_SIZE)                      //0x00080000
        #define RTK_KERNEL_SIZE     (UNIT_SIZE*96)                                   //0x00010000
        #define UIMAGE1_START       (RTK_KERNEL_START+RTK_KERNEL_SIZE)        //0x00090000
        #define UIMAGE1_SIZE        (UNIT_SIZE*160)                                   //0x00010000
        #define UIMAGE2_START       (UIMAGE1_START+UIMAGE1_SIZE)                    //0x000A0000
        #define UIMAGE2_SIZE        (UNIT_SIZE*160)                                  //0x00400000
        #define USR_APP_START       (UIMAGE2_START+UIMAGE2_SIZE)                //0x004A0000
        #define USR_APP_SIZE        (UNIT_SIZE*64)                                  //0x00100000
        #define PARA_START          (USR_APP_START+USR_APP_SIZE)                //0x005A0000
        #define PARA_SIZE           (UNIT_SIZE*16)                                  //0x00D30000 (default)
        #define SYSINFO_START       (PARA_START+PARA_SIZE)     //0x00090000
        #define SYSINFO_SIZE        (UNIT_SIZE*1)      
#endif
